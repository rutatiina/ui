...
rutatiina = function () {
    ...
    var defaults = function() {
        ...
        $('body').on('click', '[data-href]', function (e) { 
            e.preventDefault();
            //alert('clicked here: ' + $(this).data('href'));
    ...
    */
    ...
    var import_data = function (action) {
        ...
        $('body').delegate('.import_btn', 'click', function() {
            rg_import = $(this).data('import'); console.log($(this).data('import')); 
        });
    ...
    return {
        ...
        hr_form_ajax_submit: function(form_id) {
            hr_form_ajax_submit(form_id);
        },
        txn_comment_form_ajax_submit: function(form_id) {
            txn_comment_form_ajax_submit(form_id);
        },
