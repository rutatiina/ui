...
<!-- /core JS files -->
    ...
    <script src="{{ rgMix('/js/template_scripts.js') }}" defer></script>
@yield('page_js')
<!-- /theme JS files -->

</head>

<body class=" bg-light">{{--navbar-top sidebar-right-visible --}}
...
{{--        <main-navbar></main-navbar>--}}
        <div class="navbar navbar-expand-md navbar-dark d-none"></div>
        <!-- /main navbar -->
        ...
        <div class="page-content" style="min-height: 95vh;">
            ...
            <!-- Main sidebar -->
{{--            <main-sidebar v-if="menu.show"></main-sidebar>--}}
            <!-- /main sidebar -->
