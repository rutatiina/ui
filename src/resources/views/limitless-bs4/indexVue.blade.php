...
<head>
    ...
    <link href="{{mix('/css/template/styles.css')}}" rel="stylesheet" type="text/css">
    <!-- /global stylesheets -->

    <!-- Core JS files -->
    <script src="{{mix('/js/template/core_guest.js')}}" defer></script>
    <!-- /core JS files -->
                    ...
                    <form class="login-form" action="{{ route('login') }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="text"
                                       class="form-control border-0 rounded-0 {{ $errors->has('email') ? 'border-danger' : '' }}"
                                       placeholder="Email"
                                       name="email"
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="password"
                                       class="form-control border-0 rounded-0 {{ $errors->has('password') ? 'border-danger' : '' }}"
